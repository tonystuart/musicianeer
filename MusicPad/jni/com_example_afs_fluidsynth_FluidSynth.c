...
JNIEXPORT void JNICALL Java_com_example_afs_fluidsynth_FluidSynth_delete_fluid_audio_driver
  (JNIEnv *env, jclass this, jlong driver) {
  	delete_fluid_audio_driver((fluid_audio_driver_t*)driver);
}

JNIEXPORT void JNICALL Java_com_example_afs_fluidsynth_FluidSynth_delete_fluid_synth
  (JNIEnv *env, jclass this, jlong synth) {
  	delete_fluid_synth((fluid_synth_t*)synth);
}

JNIEXPORT void JNICALL Java_com_example_afs_fluidsynth_FluidSynth_delete_fluid_settings
  (JNIEnv *env, jclass this, jlong settings) {
  	delete_fluid_settings((fluid_settings_t*)settings);
}

JNIEXPORT void JNICALL Java_com_example_afs_fluidsynth_FluidSynth_fluid_settings_setint
...
JNIEXPORT void JNICALL Java_com_example_afs_fluidsynth_FluidSynth_fluid_settings_setstr
...
JNIEXPORT jint JNICALL Java_com_example_afs_fluidsynth_FluidSynth_fluid_synth_set_gain
  (JNIEnv *env, jclass this, jlong synth, jfloat gain) {
    fluid_synth_set_gain((fluid_synth_t*)synth, gain);
}

JNIEXPORT jlong JNICALL Java_com_example_afs_fluidsynth_FluidSynth_fluid_synth_sfload
...
JNIEXPORT fluid_audio_driver_t* JNICALL Java_com_example_afs_fluidsynth_FluidSynth_new_fluid_audio_driver
...
JNIEXPORT fluid_settings_t* JNICALL Java_com_example_afs_fluidsynth_FluidSynth_new_fluid_settings
  (JNIEnv *env, jclass this) {
  	return new_fluid_settings();
}

JNIEXPORT fluid_synth_t* JNICALL Java_com_example_afs_fluidsynth_FluidSynth_new_fluid_synth
  (JNIEnv *env, jclass this, jlong settings) {
