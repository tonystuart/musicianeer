...
JNIEXPORT void JNICALL Java_com_example_afs_fluidsynth_FluidSynth_delete_1fluid_1audio_1driver
  (JNIEnv *env, jclass this, jlong driver) {
  	delete_fluid_audio_driver((fluid_audio_driver_t*)driver);
}

JNIEXPORT void JNICALL Java_com_example_afs_fluidsynth_FluidSynth_delete_1fluid_1synth
  (JNIEnv *env, jclass this, jlong synth) {
  	delete_fluid_synth((fluid_synth_t*)synth);
}

JNIEXPORT void JNICALL Java_com_example_afs_fluidsynth_FluidSynth_delete_1fluid_1settings
  (JNIEnv *env, jclass this, jlong settings) {
  	delete_fluid_settings((fluid_settings_t*)settings);
}

JNIEXPORT void JNICALL Java_com_example_afs_fluidsynth_FluidSynth_fluid_1settings_1setint
...
JNIEXPORT void JNICALL Java_com_example_afs_fluidsynth_FluidSynth_fluid_1settings_1setstr
...
JNIEXPORT jint JNICALL Java_com_example_afs_fluidsynth_FluidSynth_fluid_1synth_1noteoff
  (JNIEnv *env, jclass this, jlong synth, jint chan, jint key) {
  	return fluid_synth_noteoff((fluid_synth_t*)synth, chan, key);
}

JNIEXPORT jint JNICALL Java_com_example_afs_fluidsynth_FluidSynth_fluid_1synth_1noteon
  (JNIEnv *env, jclass this, jlong synth, jint chan, jint key, jint vel) {
  	return fluid_synth_noteon((fluid_synth_t*)synth, chan, key, vel);
}

JNIEXPORT jint JNICALL Java_com_example_afs_fluidsynth_FluidSynth_fluid_1synth_1pitch_1bend
...
JNIEXPORT jlong JNICALL Java_com_example_afs_fluidsynth_FluidSynth_fluid_1synth_1sfload
...
JNIEXPORT fluid_audio_driver_t* JNICALL Java_com_example_afs_fluidsynth_FluidSynth_new_1fluid_1audio_1driver
...
JNIEXPORT fluid_settings_t* JNICALL Java_com_example_afs_fluidsynth_FluidSynth_new_1fluid_1settings
  (JNIEnv *env, jclass this) {
  	return new_fluid_settings();
}

JNIEXPORT fluid_synth_t* JNICALL Java_com_example_afs_fluidsynth_FluidSynth_new_1fluid_1synth
  (JNIEnv *env, jclass this, jlong settings) {
